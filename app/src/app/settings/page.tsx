        ...
        <div className="cyber-card p-6">
          ...
          <div className="space-y-3 pl-9 text-sm text-gray-300">
            ...
            {primaryAccount && primaryAccount.address && (
              <div className="mt-4 bg-black/50 border border-cyber-blue/30 rounded-lg p-4 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-gray-400">Wallet Address:</span>
                  <button
                    onClick={() => copyToClipboard(primaryAccount.address)}
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-cyber-blue/20 hover:bg-cyber-blue/30 transition-all group"
                    title="Copy address"
                  >
                    {copied ? (
                      <>
                      ...
                      <>
                        <Copy className="w-4 h-4 text-cyber-blue group-hover:scale-110 transition-transform" />
                        <span className="text-xs text-cyber-blue">Copy</span>
                      </>
                    )}
                  </button>
                </div>
                ...
                <div className="pt-2 border-t border-cyber-blue/20 space-y-2">
                  <a
                    href={`https://testnet.snowtrace.io/address/${primaryAccount.address}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs text-cyber-blue hover:underline flex items-center gap-1 w-fit"
                  >
                    View on Snowtrace
